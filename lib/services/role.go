...
type AccessChecker interface {
	...
	// HostUsers contains host user information matching a server or
	// an error if a role disallows host user creation
	HostUsers(s types.Server) (*HostUsersInfo, error)
}
